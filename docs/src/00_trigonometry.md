...
This module provides basic trigonometric, vector, and linear algebra
functions for triangular meshes. These are scalar or single-triangle
operations designed to be vectorized across meshes using `jax.vmap`.
