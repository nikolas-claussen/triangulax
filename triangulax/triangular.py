...
def read_obj(filename: str | Path, dim: int = 2) -> tuple[jax.Array, jax.Array]:
    ...
    return verts, jnp.array(faces, dtype=int)
    
def write_obj(vertices: jax.Array, faces: jax.Array, filename: str | Path) -> None:
    """
    ...
    Parameters
    ----------
    vertices, faces : array-like
        Vertices and faces of the mesh. Vertices can be 2D or 3D. Faces must be triangles.
    filename : str
        filename to save to
