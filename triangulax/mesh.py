...
# %% ../nbs/00_triangulation_datastructure.ipynb #d159edd4-4456-41f8-b520-8b1b69219c67
import numpy as np
...
# %% ../nbs/00_triangulation_datastructure.ipynb #9f1cb15c-86cd-4e64-8f21-d4726216cd2f
import jax
import jax.numpy as jnp

# %% ../nbs/00_triangulation_datastructure.ipynb #723a50d1-f5c2-435c-9026-39b6067f426d
...
# %% ../nbs/00_triangulation_datastructure.ipynb #7f22d2ad-1ddb-4cf3-b782-ef29639cb724
...
# %% ../nbs/00_triangulation_datastructure.ipynb #468fc48c-bf9f-46b9-bc24-74638da2c662
...
# %% ../nbs/00_triangulation_datastructure.ipynb #71736c3c-c197-48f0-8cd3-c5ba9fba9713
...
# %% ../nbs/00_triangulation_datastructure.ipynb #2c4a0e23-ac42-4264-9a38-f8745e02a131
...
# %% ../nbs/00_triangulation_datastructure.ipynb #45616576-ecbd-46f3-998b-ff82c6aa7bef
def label_plot(vertices: Float[jax.Array, "n_vertices 2"],
               faces: Int[jax.Array, "n_faces 3"],
               hemesh: type[None|Any]=None,
...
# %% ../nbs/00_triangulation_datastructure.ipynb #33c2f096-58c2-4cc1-9698-7c6a837cd730
...
# %% ../nbs/00_triangulation_datastructure.ipynb #965577eb-7900-4c5d-8f0a-8cc2fd40caba
...
# %% ../nbs/00_triangulation_datastructure.ipynb #4378ad6f
...
# %% ../nbs/00_triangulation_datastructure.ipynb #6287c71c
...
# %% ../nbs/00_triangulation_datastructure.ipynb #c7c0e33c-a06d-4a93-9d88-6aa0716bdf5b
@jax.tree_util.register_dataclass
@dataclasses.dataclass(repr=False, eq=False, frozen=True,)
class GeomMesh:
    """
...
# %% ../nbs/00_triangulation_datastructure.ipynb #a3a0cf80
...
# %% ../nbs/00_triangulation_datastructure.ipynb #504fefa9-e469-4056-a6b9-a5496b3f6ff3
class Mesh(NamedTuple):
    """Combine geometric and connectivity info into a single object."""
    geommesh: GeomMesh
    hemesh: HeMesh

# %% ../nbs/00_triangulation_datastructure.ipynb #b4ccf185-8b5b-46f9-8d3f-9c7f7d77f516
def cellplot(hemesh: HeMesh, face_positions: Float[jax.Array, "n_faces 2"],
             ...
             mpl_polygon_kwargs=type[None|Dict[str, Any]], ax: type[None|mpl.axes.Axes]=None
...
# %% ../nbs/00_triangulation_datastructure.ipynb #d8e2ff2f
...
# %% ../nbs/00_triangulation_datastructure.ipynb #2a1c1f7c-4c6e-4312-9820-cf497590c452
...
# %% ../nbs/00_triangulation_datastructure.ipynb #a5bb78ce-454d-492c-b95e-797d1ed1f2aa
...
# %% ../nbs/00_triangulation_datastructure.ipynb #242d6ee1-d553-45fc-852f-a80fbb4a589a
@jax.jit
...
# %% ../nbs/00_triangulation_datastructure.ipynb #a6feb2c8-b107-47c7-ac47-6629a29299a0
...
# %% ../nbs/00_triangulation_datastructure.ipynb #fbebd977-9ea6-4ab9-8188-d833f1bbba60
