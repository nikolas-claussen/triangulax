...
# %% auto #0
__all__ = ['label_plot', 'get_half_edge_arrays_vectorized', 'HeMesh', 'test_mesh_validity', 'get_he_length',
           'get_signed_dual_he_length', 'connect_boundary_to_infinity', 'GeomMesh', 'get_voronoi_face_positions',
           'set_voronoi_face_positions', 'Mesh', 'cellplot', 'tree_stack', 'tree_unstack']
...
# %% ../nbs/03_halfedge_datastructure.ipynb #f9d0be63
...
# %% ../nbs/03_halfedge_datastructure.ipynb #45adee95
