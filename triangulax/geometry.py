...
# %% ../nbs/src/05_geometric_quantities.ipynb #5e4c8be7
...
# %% ../nbs/src/05_geometric_quantities.ipynb #b90b4541
def get_voronoi_areas(vertices: Float[jax.Array, "n_vertices dim"], hemesh: msh.HeMesh
    ...
    Important: This function computes the exact Voronoi cell area (in any dimension), but
    can lead to _numerical_ instabilities for very obtuse triangles. For use cases where the cell area
    serves as a tool (e.g. for discretizing the area integral), prefer get_voronoi_areas_robust.
    """
...
def get_voronoi_areas_robust(vertices: Float[jax.Array, "n_vertices dim"], hemesh: msh.HeMesh
    ...
    See Fig 4 from M Meyer, M Desbrun, P Schröder, A H Barr: "Discrete Differential-Geometry Operators
