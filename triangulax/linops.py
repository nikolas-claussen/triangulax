...
# %% auto #0
__all__ = ['scipy_to_bcoo', 'diag_jsparse', 'compute_cotan_laplace', 'cotan_laplace_sparse', 'mass_matrix_sparse',
           'mass_matrix_inv_sparse', 'compute_gradient_2d', 'compute_gradient_3d', 'gradient_sparse_2d',
           'gradient_sparse_3d', 'reshape_face_gradient', 'linear_op_to_sparse']
